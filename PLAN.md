...
- [x] Project name: **mcpforge** (decided Aug 30, 2026) — **superseded, see section 13 below: name collision found (real npm package + real GitHub project both already named `mcpforge`), rebrand decided Sep 3, 2026 to `klaridian`, tracked in Plane MCPFO-13.**
