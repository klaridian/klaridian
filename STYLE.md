...
- Generated content (API reference tables, changelogs assembled from commit messages, etc.) is exempt where the source data itself doesn't follow prose conventions.
