...
# `ricardocvasconcelos/homebrew-klaridian` (Formula/klaridian.rb). It downloads
...
class Klaridian < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/ricardocvasconcelos/klaridian/releases/download/v__VERSION__/klaridian-darwin-arm64"
      sha256 "__SHA_DARWIN_ARM64__"
    end
    on_intel do
      url "https://github.com/ricardocvasconcelos/klaridian/releases/download/v__VERSION__/klaridian-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/ricardocvasconcelos/klaridian/releases/download/v__VERSION__/klaridian-linux-arm64"
      sha256 "__SHA_LINUX_ARM64__"
    end
    on_intel do
      url "https://github.com/ricardocvasconcelos/klaridian/releases/download/v__VERSION__/klaridian-linux-x64"
